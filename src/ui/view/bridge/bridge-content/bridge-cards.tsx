...
const BridgeCards: FC = () => {
  return (
    <div className="grid w-full md:grid-cols-4 px-2 md:px-16 grid-cols-2 items-center gap-4 place-items-center">
      <TransparentCard className="rounded-2xl w-40 h-32 md:w-56 md:h-32">
