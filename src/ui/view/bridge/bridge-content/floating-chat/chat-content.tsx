...
const ChatContent: FC<ChatContentProps> = ({ toggleModal }) => {
  return (
    <div className="inset-0 rounded-xl flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="w-full w-screen h-screen md:max-w-sm md:h-[40rem] flex flex-col bg-tertiary text-white rounded-lg overflow-hidden shadow-xl transform transition-all">
